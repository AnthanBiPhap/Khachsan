...
| 7 | role | String | 20 | NO | - | - | 'customer' | enum: customer/staff/admin | Vai trò người dùng |
| 8 | status | String | 20 | NO | - | - | 'active' | enum: active/blocked | Trạng thái tài khoản |
| 9 | preferences | Array | - | NO | - | - | ['tham quan',...] | Array of strings | Sở thích người dùng |
| 10 | emailVerified | Boolean | - | NO | - | - | false | - | Email đã xác thực |
| 11 | emailVerificationToken | String | 255 | YES | - | - | NULL | - | Token xác thực email |
| 12 | emailVerificationTokenExpires | Date | - | YES | - | - | NULL | - | Thời hạn token xác thực |
| 13 | passwordResetOTP | String | 10 | YES | - | - | NULL | - | OTP reset mật khẩu (6-10 ký tự) |
...
| 4 | description | String | 1000 | YES | - | - | NULL | trim | Mô tả địa điểm |
| 5 | address | String | 500 | YES | - | - | NULL | trim | Địa chỉ |
| 6 | images | Array | - | NO | - | - | [] | Array of URLs | Danh sách hình ảnh |
| 7 | ratingAvg | Number | - | NO | - | - | 0 | min: 0, max: 5 | Điểm đánh giá trung bình |
| 8 | status | String | 20 | NO | - | - | 'active' | enum: active/hidden/deleted | Trạng thái |
...
| 4 | status | String | 20 | NO | - | - | 'available' | enum: available/booked/maintenance/checked_in/occupied/unavailable | Trạng thái phòng |
...
| 9 | source | String | 20 | NO | - | - | 'walk_in' | enum: online/walk_in | Nguồn đặt phòng |
| 10 | totalPrice | Number | - | NO | - | - | - | required, min: 0 | Tổng tiền (VND) |
| 11 | paidAmount | Number | - | NO | - | - | 0 | min: 0 | Số tiền đã thanh toán (VND) |
| 12 | remainingAmount | Number | - | NO | - | - | 0 | min: 0 | Số tiền còn lại (VND) |
| 13 | paymentStatus | String | 30 | NO | - | - | 'pending' | enum: pending/partial_paid/paid/failed/refunded/refund_requested/cancelled | Trạng thái thanh toán |
| 14 | notes | String | 500 | YES | - | - | NULL | trim, max: 500 | Ghi chú |
...
| 10 | notes | String | 500 | YES | - | - | NULL | max: 500 | Ghi chú |
| 11 | status | String | 30 | NO | - | - | 'pending_approval' | enum: pending_approval/approved/info_uploaded/quoted/awaiting_payment/deposit_paid/paid/confirmed/refund_requested/refunded/cancelled/rejected | Trạng thái đặt phòng nhóm |
...
| 15 | paymentLink | String | 500 | YES | - | - | NULL | URL format | Link thanh toán |
...
| 8 | status | String | 20 | NO | - | - | 'active' | enum: active/hidden/deleted | Trạng thái dịch vụ |
| 9 | createdAt | DateTime | - | NO | - | - | AUTO | timestamps | Ngày tạo |
| 10 | updatedAt | DateTime | - | NO | - | - | AUTO | timestamps | Ngày cập nhật |
...
| 5 | guestName | String | 100 | YES | - | - | NULL | trim, min: 2, max: 100 | Tên khách (nếu không có customerId) |
| 6 | phoneNumber | String | 13 | YES | - | - | NULL | trim, VN phone format | SĐT khách |
...
| 10 | status | String | 20 | NO | - | - | 'reserved' | enum: reserved/completed/cancelled | Trạng thái đặt dịch vụ |
...
| 8 | paymentStatus | String | 30 | NO | - | - | 'pending' | enum: pending/partial_paid/paid/failed/refunded/refund_requested/cancelled | Trạng thái thanh toán |
| 9 | status | String | 20 | NO | - | - | 'pending' | enum: pending/paid/failed/refunded | Trạng thái hóa đơn |
...
| 7 | currency | String | 3 | NO | - | - | 'VND' | - | Đơn vị tiền tệ (VND, USD, ...) |
| 8 | status | String | 20 | NO | - | - | 'pending' | enum: pending/completed/failed/cancelled/refunded | Trạng thái thanh toán |
| 9 | stripeSessionId | String | 100 | YES | - | - | NULL | required if paymentMethod=stripe | ID session Stripe |
| 10 | stripePaymentIntentId | String | 100 | YES | - | - | NULL | - | ID payment intent Stripe |
| 11 | stripeCustomerId | String | 100 | YES | - | - | NULL | - | ID khách hàng Stripe |
| 12 | transactionId | String | 100 | YES | Unique | - | NULL | unique, sparse | Mã giao dịch (duy nhất khi có giá trị) |
| 13 | bankInfo | Object | - | YES | - | - | NULL | Embedded: {bankName: 100, accountNumber: 50, transactionCode: 50} | Thông tin chuyển khoản |
| 14 | cashInfo | Object | - | YES | - | - | NULL | Embedded: {receivedBy: 100, receivedAt, notes: 500} | Thông tin tiền mặt |
| 15 | refundInfo | Object | - | YES | - | - | NULL | Embedded: {refundAmount, refundReason: 500, refundedAt, refundedBy: 100} | Thông tin hoàn tiền |
| 16 | metadata | Map | - | YES | - | - | {} | Map of Mixed | Metadata bổ sung |
| 17 | notes | String | 500 | YES | - | - | NULL | trim, max: 500 | Ghi chú |
...
| 4 | actorName | String | 100 | YES | - | - | NULL | trim | Tên người thực hiện (admin/staff hoặc tên user) |
...
| 6 | note | String | 500 | YES | - | - | NULL | trim, max: 500 | Ghi chú |
| 7 | createdAt | DateTime | - | NO | - | - | AUTO | timestamps | Ngày tạo |
| 8 | updatedAt | DateTime | - | NO | - | - | AUTO | timestamps | Ngày cập nhật |
...
| 6 | comment | String | 2000 | YES | - | - | NULL | trim | Bình luận |
| 7 | status | String | 20 | NO | - | - | 'active' | enum: active/hidden/deleted | Trạng thái đánh giá |
...
| 5 | status | String | 20 | NO | - | - | 'active' | enum: active/archived/deleted | Trạng thái cuộc trò chuyện |
...
| 5 | messageType | String | 20 | NO | - | - | 'text' | enum: text/image/file/system | Loại tin nhắn |
| 6 | attachments | Array | - | NO | - | - | [] | Embedded documents | Tệp đính kèm [{url: 500, type: 50, name: 255, size}] |
| 7 | status | String | 20 | NO | Index | - | 'sent' | enum: sent/delivered/read/deleted | Trạng thái tin nhắn |
...
| 9 | status | String | 20 | NO | Index | - | 'active' | enum: active/archived/deleted | Trạng thái thông báo |
