  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 rounded-xl p-4 shadow-sm animate-in slide-in-from-top-2 duration-300">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-3 pt-4 border-t border-gray-200">
              <Label className="text-sm font-semibold text-gray-700">Sở thích của bạn</Label>
              <div className="grid grid-cols-2 gap-3">
                {DEFAULT_PREFERENCES.map((pref) => (
                  <div key={pref} className="flex items-center space-x-3 p-3 rounded-xl border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200">
                    <Checkbox 
                      id={`pref-${pref}`}
