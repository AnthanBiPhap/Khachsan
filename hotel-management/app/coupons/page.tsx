...
import { Tag, Copy, Gift, Calendar, Users, Percent, DollarSign, Star, Clock, CheckCircle2, ArrowLeft } from "lucide-react";
...
export default function CouponsPage() {
  ...
  useEffect(() => {
    const fetchCoupons = async () => {
      try {
        setLoading(true);
        const url = `${API_URL}/coupons/public?limit=100`;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Tất Cả Mã Giảm Giá</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Khám phá tất cả các ưu đãi hấp dẫn và tiết kiệm chi phí cho chuyến đi của bạn
            </p>
          </div>
        </div>
